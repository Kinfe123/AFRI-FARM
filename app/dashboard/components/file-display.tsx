...
import { ExampleFrame } from '@/components/frame-upload';
import {
  MultiFileDropzone,
  type FileState,
} from './file-upload';
...
export default function FilePage({updateData}:any) {
  return (
    <ExampleFrame>
      <MultiImageExample updateData={updateData} />
    </ExampleFrame>
  );
}

// @ts-ignore
function MultiImageExample({updateData}) {
